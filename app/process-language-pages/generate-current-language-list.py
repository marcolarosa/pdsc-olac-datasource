...
if __name__ == "__main__":
    ...
    parser.add_argument('--languages', dest='languages',
                        help='The path to the CSV file containing the language codes', required=True)
    parser.add_argument('--glotto-languoids', dest='languoids',
                        help='The path to glottolog languoids CSV file', required=True)
    parser.add_argument('--mode', dest='mode', choices=['development', 'testing'],
                        help='The mode in which to run - limits the processing.')
    parser.add_argument('--service', dest='service', help='The url to submit the data to.', required=True)
